...
const STEPS = [
  ...
  },
  {
    n: '04',
    title: 'Get paid',
    body: 'Store credit lands on your GAME MANIA account. Cash is sent by manual bank transfer.',
  },
] as const;
    ...
    <main className="relative overflow-hidden">
      ...
      <section className="relative mx-auto grid max-w-6xl gap-10 px-4 pb-8 pt-12 md:grid-cols-[1.1fr_0.9fr] md:px-6 md:pt-16">
        <div>
          ...
          >
            Instant quote for cash or boosted store credit. Credit is applied to your GAME MANIA
            account. Cash payouts are sent manually by bank transfer after approval.
          </motion.p>
          <motion.div
      ...
      <section className="relative mx-auto max-w-6xl px-4 py-14 md:px-6">
        ...
        <p className="mt-2 max-w-2xl text-sm text-[var(--gm-muted)]">
          Inspired by the best UK trade flows — quote, send, test, pay — with GAME MANIA credit or
          cash transfer.
        </p>
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    ...
                    >
                      ...
                      <p className="mt-2 text-xs text-[var(--gm-muted)]">
                        Applied to your account after we approve & mark paid. Higher than cash.
                      </p>
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      ...
                      <p className="mt-2 text-xs text-[var(--gm-muted)]">
                        Paid by manual bank transfer after grading & approval — not instant.
                      </p>
                    </button>
                  </div>
